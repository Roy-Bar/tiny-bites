...
import type { FeedingTypeId } from '../../types'

interface FeedingTypeSelectorProps {
  value: FeedingTypeId
  onChange: (next: FeedingTypeId) => void
}

export default function FeedingTypeSelector({ value, onChange }: FeedingTypeSelectorProps) {
  return (
